...
public class DFATest {
	...
	private DFA dfa4() {
		...
		assertTrue(dfa.addTransition("q2", "q4", 'a'));
		assertTrue(dfa.addTransition("q3", "q4", 'b'));
		assertTrue(dfa.addTransition("q4", "q4", 'a'));
		assertTrue(dfa.addTransition("q4", "q4", 'b'));

		assertFalse(dfa.addTransition("q1", "q5", 'c'));
		assertFalse(dfa.addTransition("q1", "q3", 'c'));
	...
	public void testInvalidTransitions() {
		...
		assertFalse(dfa.addTransition("a", "c", '1'));
		assertFalse(dfa.addTransition("a", "b", '2'));
		System.out.println("Invalid transitions handled correctly");
	}
	...
	public void testSwapNonExistentSymbols() {
		DFA dfa = dfa1();
		DFA swappedDFA = dfa.swap('x', 'y');
		assertNotEquals(dfa, swappedDFA);
		System.out.println("Swapping non-existent symbols handled correctly");
	}
}
